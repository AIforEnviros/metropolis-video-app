...
- Scrub session data uses session format v1.9 with enabled/mode/range/speed saved per video slot
...
**Original MIDI session format (v1.4; current application format is v1.9):**
```json
{
  "version": "1.4",
  "keyboardShortcuts": { ... },
