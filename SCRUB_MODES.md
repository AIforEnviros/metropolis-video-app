...
Scrub settings are stored in the application's session format **v1.12**.
...
- Per-slot mode/range/speed/B-F-options/ON-OFF restoration and session v1.12 round-tripping
